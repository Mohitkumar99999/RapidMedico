package com.rapidmedico.service.impl;
...
import com.rapidmedico.beans.DemandBean;
import com.rapidmedico.beans.ProductBean;
import com.rapidmedico.service.ProductService;
import com.rapidmedico.utility.DBUtil;
import com.rapidmedico.utility.IDUtil;
import com.rapidmedico.utility.MailMessage;
...
public class ProductServiceImpl implements ProductService {
	...
	public List<ProductBean> getAllProductsByType(String type) {
		...
		try {
			ps = con.prepareStatement("SELECT * FROM `rapidmedico`.product where lower(ptype) like ?;");
			ps.setString(1, "%" + type + "%");
			rs = ps.executeQuery();
	...
	public List<ProductBean> searchAllProducts(String search) {
		...
		try {
			ps = con.prepareStatement(
					"SELECT * FROM `rapidmedico`.product where lower(ptype) like ? or lower(pname) like ? or lower(pinfo) like ?");
			search = "%" + search + "%";
