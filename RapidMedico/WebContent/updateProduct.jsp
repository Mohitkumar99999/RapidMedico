					...
					<div class="col-md-6 form-group">
						...
						<label for="producttype">Product Type</label> <select name="type"
							...
							<option value="VITAMINS"
								<%="VITAMINS".equalsIgnoreCase(ptype) ? "selected" : ""%>>VITAMINS</option>
							<option value="PERSONALCARE"
								<%="PERSONALCARE".equalsIgnoreCase(ptype) ? "selected" : ""%>>PERSONALCARE</option>
							<option value="DIABETESSUGARCARE"
								<%="DIABETESSUGARCARE".equalsIgnoreCase(ptype) ? "selected" : ""%>>DIABETESSUGARCARE</option>
							<option value="COVIDESSENTIALS"
								<%="COVIDESSENTIALS".equalsIgnoreCase(ptype) ? "selected" : ""%>>COVIDESSENTIALS</option>
							<option value="Genericmedicine"
								<%="Genericmedicine".equalsIgnoreCase(ptype) ? "selected" : ""%>>Genericmedicine</option>
							<option value="HEALTHCONDITIONS"
								<%="HEALTHCONDITIONS".equalsIgnoreCase(ptype) ? "selected" : ""%>>HEALTHCONDITIONS</option>
							<option value="other"
