...
<%@ page import="com.rapidmedico.service.impl.*, com.rapidmedico.service.*"%>
		...
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.jsp"><span
					class="glyphicon glyphicon-home">&nbsp;</span>Rapid Medico</a>
			</div>
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav navbar-right">
                                        <li><a href="Uploadprescription.jsp">Uploadprescription  For Urgent Medicine</a></li>
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							<li><a href="index.jsp?type=VITAMINS">VITAMINS</a></li>
							<li><a href="index.jsp?type=PERSONALCARE">PERSONALCARE</a></li>
							<li><a href="index.jsp?type=DIABETESSUGARCARE">DIABETESSUGARCARE</a></li>
							<li><a href="index.jsp?type=COVIDESSENTIALS">COVIDESSENTIALS</a></li>
							<li><a href="index.jsp?type=Genericmedicine">Genericmedicine</a></li>
							<li><a href="index.jsp?type=HEALTHCONDITIONS">HEALTHCONDITIONS</a></li>
						</ul></li>
				</ul>
			</div>
		</div>
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							<li><a href="userHome.jsp?type=VITAMINS">VITAMINS</a></li>
							<li><a href="userHome.jsp?type=PERSONALCARE">PERSONALCARE</a></li>
							<li><a href="userHome.jsp?type=DIABETESSUGARCARE">DIABETESSUGARCARE</a></li>
							<li><a href="userHome.jsp?type=HOMEOPATHY">HOMEOPATHY</a></li>
							<li><a href="userHome.jsp?type=Genericmedicine">Genericmedicine</a></li>
							<li><a href="userHome.jsp?type=HEALTHCONDITIONS">HEALTHCONDITIONS</a></li>
						</ul></li>
					<%
					if (notf == 0) {
					%>
