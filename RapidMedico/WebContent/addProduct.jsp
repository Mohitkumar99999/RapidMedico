				...
				<div class="row">
					...
					<div class="col-md-6 form-group">
						<label for="producttype">Product Type</label> <select name="type"
							...
							<option value="DIABETESSUGARCARE">DIABETESSUGARCARE</option>
							<option value="COVIDESSENTIALS">COVIDESSENTIALS</option>
							<option value="Genericmedicine">Genericmedicine</option>
							<option value="HEALTHCONDITIONS">HEALTHCONDITIONS</option>
							<option value="other">Some Other Medicine</option>
						</select>
					</div>
				</div>
